...
""",
"""
insert into configuration (label,key, int_value, description)values('min transactions 30','report.min.transactions.30', 1,'Min transactions last 30 days' ) on conflict do nothing;
insert into configuration (label,key, int_value, description)values('min transactions 60','report.min.transactions.60', 2,'Min transactions last 60 days' ) on conflict do nothing;
insert into configuration (label,key, int_value, description)values('min transactions 90','report.min.transactions.90', 3,'Min transactions last 90 days' ) on conflict do nothing;
insert into configuration (label,key, int_value, description)values('min transactions 180','report.min.transactions.180', 3,'Min transactions last 180 days' ) on conflict do nothing;
insert into configuration (label,key, int_value, description)values('min transactions 180+','report.min.transactions.180plus', 15,'Min known transactions' ) on conflict do nothing;
""",
